...
const questionSituation = document.querySelector('.question-situation');
...
const questionImage = document.querySelector('[data-output="output--question-image"]');
// *** Options
...
function loadQuestions(){
    ...
    if(questionArray[questionIndex].questionSituationInstruction) {
        const questionSituationInstruction = document.createElement('p');
        questionSituationInstruction.classList.add('question-situation-instruction');
        questionSituationInstruction.innerText = questionArray[questionIndex].questionSituationInstruction;
        questionSituation.appendChild(questionSituationInstruction);
    }
    if(questionArray[questionIndex].questionSituationText) {
        const questionSituationText = document.createElement('span');
        questionSituationText.classList.add('question-situation-text');
        questionSituationText.innerText = questionArray[questionIndex].questionSituationText;
        questionSituation.appendChild(questionSituationText);
    }
...
function validateSelection() {
    if(!options[0].classList.contains("disabled")) {
        ...
        if(questionSituation.innerHTML !== "") {
...
function selectGradeNumber() {
    switch(quizInformation.dataset.input) {
        case "grade-1":
            ...
            break;
        case "grade-2":
            questionArray = questionArray_G2;
            break;
        case "grade-3":
            questionArray = questionArray_G3;
            break;
        case "grade-4":
            questionArray = questionArray_G4;
            break;
    }
